# Guia do GitHub Spec Kit

> ⚠️ **Nota (2026-06-15):** Este é um **manual genérico do Spec Kit**, herdado de outro projeto
> (os exemplos abaixo são de um jogo "Banco Master"/Monopoly e **não se aplicam a este app**).
> Leia-o apenas para entender *como* o Spec Kit funciona. A **fonte de verdade deste projeto**
> (CCA-F Exam Prep App) é a `.specify/memory/constitution.md` + `specs/`, e o `CLAUDE.md` na raiz.
> Onde o texto fala em "SRS.md", "DECISIONS.md" ou princípios de regras de jogo, ignore — são
> convenções do projeto antigo.

> Este documento é pra você (Nikolas) aprender a usar o Spec Kit do zero.
